...
\title{SNORT\textsuperscript{\textregistered} Users Manual\\2.9.9}
...
Copyright \copyright 2014-2016 Cisco and/or its affiliates. All rights reserved.
...
\begin{itemize}
\item Install nghttp library from https://nghttp2.org/
\item If nghttp is not installed in default path, use with\_libnghttp2\_includes and
with\_libnghttp2\_libraries to point to the correct path during ``configure'' step.
\item  Enable HTTP2 support in http\_inspect configuration with ``legacy\_mode no''
\end{itemize}
